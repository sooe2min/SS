				...
				<div className="filter">
					...
					<span className="ft_list">
						...
						<div className="ft_resion">
							<ul
								className="ft_ul"
								onClick={e => this.props.addQuery(e, 'resion')}>
								<li>서울특별시</li>
								<li>부산광역시</li>
								<li>인천광역시</li>
								<li>대구광역시</li>
					...
					<span className="ft_list">
						...
						<ul
							...
							<li
								className={this.state.filter_check ? 'ft_check_ic' : null}
								onClick={this.filterOn.bind(this)}>
								Planner
							</li>
							<li
								className={this.state.filter_check ? 'ft_check_ic' : null}
							...
							<li
								className={this.state.filter_check ? 'ft_check_ic' : null}
								onClick={e => this.filterOn.bind(this)}>
								ETC
							</li>
						</ul>
					</span>
					...
					<span
						...
						<ul
							className="ft_ul"
							onClick={e => this.props.addQuery(e, 'state')}>
							<li>구직중</li>
							<li>구인중</li>
							<li>재직중</li>
							<li>이직희망</li>
